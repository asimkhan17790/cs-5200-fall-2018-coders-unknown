...
class OrderSummaryModalItem extends React.Component {
...
OrderSummaryModalItem.propTypes = {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(OrderSummaryModalItem));